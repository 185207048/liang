                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <div class="row">
                                <div class="col-md-6">
                                    <h3>修改信息</h3>
                                    <form action="UploadCActivityServlet" method=post enctype="multipart/form-data">  
                                    	<div class="form-group" hidden="hidden">
                                 			<input class="form-control" name="cmd" value="1" id="cmd">
                                    	</div>
                                        ...
                                        <div class="form-group">
                                            <label>活动题目</label>
                                            <input class="form-control" name="title" value="<%=a.getTitle()%>" />
                                        </div>
                                        <div class="form-group">
                                            <label>活动信息</label >
                                            <input class="form-control" name="info" value="<%=a.getInfo()%>" />
                                        </div>
                                        <div class="form-group">
                                            <label>封面图片</label>
                                           		<%
                                         		...
                                         		%>
                                            	<!--  <div style="width:40rem;height:40rem;background:url(<%=a.getImg()%>);background-repeat: no-repeat;background-size: 100% 100%;-moz-background-size: 100% 100%;"></div>-->
                                  				<div><img src="<%=a.getImg()%>" style="width:20rem;height:20rem" /></div>
                                           		<div><input type="file" name="img" id="l_submit"></div>
                                           <!-- <input   /> --> 
                                        </div>
