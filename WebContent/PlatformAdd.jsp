...
font-size: 16px;">  &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">注销</a> </div>
 ...
 <%
 		...
 		System.out.println("platform:"+platform.getPublisher());
 		
 		String user=new UserDao().getNameFromaid(id);
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <div class="row">
                                <div class="col-md-6">
                                    <h3>上传视频</h3>
                                     <form action="UploadPlatformServlet"   method=post enctype="multipart/form-data">  
                                     <div class="form-group">
                                            
                                            <input class="form-control" type="hidden"value="<%=platform.getId() %>" readOnly="true"/>
                                     
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>视频标题</label>
                                            <input class="form-control" name="title" required="required" value=""/>
                       
                                        </div>
                                        <div class="form-group">
                                            <label>视频作者</label>
                                             <input class="form-control" name="publisher" type="hidden" required="required" readOnly="true" value="<%=id%>"/>
                                        ...
                                        <div class="form-group">
                                        <label>视频介绍</label>
                                            <input class="form-control" name="context" required="required"  value=""/>
                                       ...
                                       <div class="form-group">
                                            <label>视频连接</label>
                                            <input class="form-control" name="video" required="required" value=""/>
                                        </div>
                       					<div class="form-group">
                                            <label>视频状态</label>
