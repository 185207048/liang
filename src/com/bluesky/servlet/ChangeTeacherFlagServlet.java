...
@WebServlet("/ChangeTeacherFlagServlet")
public class ChangeTeacherFlagServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ChangeTeacherFlagServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray ja = JSONArray.fromObject(new TeacherDao().changeTeacherFlag(id, aid, flag));
		out.print(ja);
		out.flush();
		out.close();
	}
