...
@WebServlet("/GetAllImgServlet")
public class GetAllImgServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public GetAllImgServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray ja = JSONArray.fromObject(new ImgDao().getAllImg(start, end));
		out.print(ja);
		out.flush();
		out.close();
	}
